...
const projects: Project[] = [
  {
    ...
    description:
      "Built an interactive food review website using React.js, TypeScript, and Supabase as a backend-as-a-service platform.",
    image:
  ...
  },
  {
    ...
    type: "Data pipeline",
    description:
      "Developed a real-world Formula 1 data pipeline on Azure Databricks using Spark Core and Delta Lake, integrating raw telemetry and race datasets into a structured data lakehouse.",
    image:
  ...
  },
  {
    ...
    type: "SQL ingestion",
    description:
      "Designed and implemented a hybrid data architecture combining MongoDB for semi-structured JSON documents and MySQL for relational subsets to benchmark query cost and performance. ",
    image:
  ...
  },
  {
    ...
    image: "https://i.ytimg.com/vi/aircAruvnKk/sddefault.jpg",
    github:
      "https://github.com/Edwardko2004?tab=repositories&q=&type=&language=&sort=name", // TODO: replace
  },
  {
